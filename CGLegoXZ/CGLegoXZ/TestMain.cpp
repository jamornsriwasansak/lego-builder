...
void handleKeypress(unsigned char key, int x, int y) {
	...
	switch(key) {
		...
		case'q':bpq=true; spin(World::bp,.03);break;
		case'e':bpe=true;spin(World::bp,-.03); break;
		case '0':World::isbp=!World::isbp; cout<<"!!!!!! World::bp "<<World::isbp<<" !!!!\n\n";if(World::isbp)meet=false;break;
...
int thesholdss=30;
bool uuu=false,ddd=false,lll=false,rrr=false;
